...
\begin{center}
	\centering
\includegraphics[scale=0.5]{Errorenlosmetodos.jpg}
...
\begin{center}
	\centering
	\includegraphics[scale=0.6]{algoritmos.jpg}
	\\
...
\noindent Para este problema que consiste en modelar la economía de un país ,usar el método de Factorización LDLt es muy perjudicial, esto podria generar muchas perdidas económicas, generar una mayor inflación y por consecuencia la población seria la más afectada.
